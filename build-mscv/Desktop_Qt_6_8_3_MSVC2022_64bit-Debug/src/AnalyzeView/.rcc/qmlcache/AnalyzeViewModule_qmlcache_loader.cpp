...
namespace _qml_QGroundControl_AnalyzeView_GeoTagPage_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qml/QGroundControl/AnalyzeView/GeoTagPage.qml"), &QmlCacheGeneratedCode::_qml_QGroundControl_AnalyzeView_GeoTagPage_qml::unit);
