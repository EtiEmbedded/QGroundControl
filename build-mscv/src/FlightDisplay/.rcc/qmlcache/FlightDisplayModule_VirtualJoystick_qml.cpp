...
Q_UNUSED(aotContext)
Q_UNUSED(argv)
// expression for _activeVehicle at line 26, column 5
QObject *r2_1;
QObject *r2_0;
QVariant r2_2;
...
aotContext->setInstructionPointer(4);
#endif
aotContext->initGetObjectLookup(1, r2_0, []() { static const auto t = QMetaType::fromName("MultiVehicleManager*"); return t; }());
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<QVariant *>(argv[0]) = QVariant();
